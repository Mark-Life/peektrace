/** Pure, dependency-light syntax tokenizer shared by the web inspector and the CLI.
 *
 * Wraps `@tanstack/highlight` (no wasm, no DOM) into a string -> lines-of-tokens
 * function. Both surfaces map the emitted `className` onto their own palette:
 * CSS classes on the web, RGBA spans in the terminal.
 */
...
export type { HighlightTokenClass } from "@tanstack/highlight/core";
